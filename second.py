...
if selected == "Home":
    with st.container():
         ...
         st.write("#")
         st.write("This is where I store all my projects, I make these project outside of school as a hobby. 
         I'm excited to learn more as I go on with making stuff! Maybe even learn other programming languages.")
